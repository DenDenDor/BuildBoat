...
namespace CMF
{
	...
	public class Mover : MonoBehaviour {
		...
		//public SmoothPosition CameraSmoothPosition;
		...
		public Rigidbody Ragdoll => _ragdoll;
		...
		public Vector3 Velocity => rig.linearVelocity;
		...
		private void Save()
		{
			...
			// {
			// 	rig.velocity = new Vector3(rig.velocity.x, veloc.y, rig.velocity.z);
			// }
		}
		...
		{
			rig.MovePosition(_startPosition);
		}
